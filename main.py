...
bg='white',bd=0,command=lambda:os.system('')).grid(padx=10,pady=10,sticky='w')

networkimg=PhotoImage(file='network.png')
Button(frame,text="Network Setting",font=('Sans Serif',15,'bold'),fg='blue',image=networkimg,compound=LEFT,cursor='hand2',
bg='white',bd=0,command="ncpa.cpl",command=lambda:os.system('ncpa.cpl')).grid(row=1,column=1,padx=10,pady=10,sticky='w')
...
bg='white',bd=0).grid(padx=10,pady=10,sticky='w')
...
bg='white',bd=0).grid(row=2,column=1,padx=10,pady=10,sticky='w')
...
bg='white',bd=0).grid(row=3,column=1,padx=10,pady=10,sticky='w')
